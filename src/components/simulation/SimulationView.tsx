  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-slate-50 text-slate-800">
      ...
      <div className="flex flex-col flex-1 min-w-0 overflow-hidden min-h-0 relative">
        ...
        {/* ── Header ── */}
        <header
          className="flex-shrink-0 flex items-center justify-between px-5 py-2.5 relative z-20 bg-white border-b border-slate-200 shadow-sm"
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[0.55rem] mt-0.5 text-slate-500">จำลองแผนตารางเดินรถ — Round-Robin Fairness</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div
              className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-[0.5rem] font-semibold bg-cyan-50 text-cyan-700 border border-cyan-200"
            >
