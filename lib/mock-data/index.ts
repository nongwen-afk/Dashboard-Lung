...
export const DRIVERS: Driver[] = [
  // ---- สายสีเขียว / Green Line (L3) ----
  {
    ...
    status: "Active",
    experience: 6,
    performance: { onTimeRate: 92, avgDelay: 2.5, rating: 4.8, totalTrips: 156 },
  },
  {
    id: 2,
    name: "ธนกฤต",
    ...
    status: "Active",
    experience: 4,
    performance: { onTimeRate: 85, avgDelay: 5.2, rating: 4.2, totalTrips: 120 },
  },
  {
    id: 3,
    name: "สุธรรม",
    ...
    status: "Active",
    experience: 7,
    performance: { onTimeRate: 95, avgDelay: 1.2, rating: 4.9, totalTrips: 210 },
  },
  {
    id: 4,
    name: "บัวทอง",
    ...
    status: "Active",
    experience: 5,
    performance: { onTimeRate: 78, avgDelay: 8.5, rating: 3.8, totalTrips: 98 },
  },
  {
    id: 5,
    name: "อัธยา",
    ...
    status: "Active",
    experience: 3,
    performance: { onTimeRate: 88, avgDelay: 4.0, rating: 4.5, totalTrips: 145 },
  },
  ...
  // ---- สายสีน้ำเงิน / Blue Line (L2) ----
  {
    ...
    status: "Active",
    experience: 8,
    performance: { onTimeRate: 94, avgDelay: 2.0, rating: 4.7, totalTrips: 240 },
  },
  {
    id: 7,
    name: "เฉลิมพล",
    ...
    status: "Active",
    experience: 5,
    performance: { onTimeRate: 82, avgDelay: 6.8, rating: 4.0, totalTrips: 135 },
  },
  {
    id: 8,
    name: "บดินทร์",
    ...
    status: "Active",
    experience: 2,
    performance: { onTimeRate: 89, avgDelay: 3.5, rating: 4.3, totalTrips: 85 },
  },
  {
    id: 9,
    name: "คมสันต์",
    ...
    status: "Active",
    experience: 6,
    performance: { onTimeRate: 91, avgDelay: 2.8, rating: 4.6, totalTrips: 180 },
  },
  {
    id: 10,
    name: "เปรม",
    ...
    status: "Active",
    experience: 9,
    performance: { onTimeRate: 96, avgDelay: 1.0, rating: 4.9, totalTrips: 290 },
  },
  ...
  // ---- สายสีแดง / Red Line (L1) ----
  {
    ...
    status: "Active",
    experience: 10,
    performance: { onTimeRate: 98, avgDelay: 0.5, rating: 5.0, totalTrips: 320 },
  },
  {
    id: 12,
    name: "วีระ",
    ...
    status: "Active",
    experience: 4,
    performance: { onTimeRate: 84, avgDelay: 5.5, rating: 4.1, totalTrips: 115 },
  },
  {
    id: 13,
    name: "ชาติ",
    ...
    status: "Active",
    experience: 3,
    performance: { onTimeRate: 75, avgDelay: 10.2, rating: 3.5, totalTrips: 70 },
  },
  {
    id: 14,
    name: "ธนบูรณ์",
    ...
    status: "Active",
    experience: 2,
    performance: { onTimeRate: 86, avgDelay: 4.5, rating: 4.2, totalTrips: 60 },
  },
  {
    id: 15,
    name: "พรหมพิพัฒน์",
    ...
    status: "Active",
    experience: 5,
    performance: { onTimeRate: 90, avgDelay: 3.0, rating: 4.5, totalTrips: 150 },
  },
];
