...
const GREEN_WEEKEND: TimetableHourRow[] = [row(8, ["20", "40"]), row(9, ["10", "30", "50"])];
...
const BLUE_WEEKEND: TimetableHourRow[] = [row(8, ["20", "40"]), row(9, ["10", "30", "50"])];
...
const RED_WEEKEND: TimetableHourRow[] = [row(8, ["30", "50"]), row(9, ["10", "30", "50"])];
