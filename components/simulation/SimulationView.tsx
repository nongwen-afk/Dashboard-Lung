  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-slate-50 text-slate-800">
      ...
      <div className="flex flex-col flex-1 min-w-0 overflow-hidden min-h-0 relative">
        {/* ── Header ── */}
        <header className="flex-shrink-0 flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-0 px-4 md:px-5 py-3 md:py-2.5 relative z-20 bg-white border-b border-slate-200 shadow-sm">
          ...
          <div className="flex-1 min-w-0 flex justify-start md:justify-end">
            ...
            >
              ...
              <div className="flex items-center gap-1.5 mr-3">
                <span className="text-xs text-slate-500 font-bold uppercase tracking-wide mr-1 whitespace-nowrap flex-shrink-0">
                  แสดง:
                </span>
                <button
        ...
        <div className="flex-1 min-h-0 flex overflow-hidden relative">
          ...
          <div
            className={`transition-all duration-300 ease-in-out flex-shrink-0 bg-white z-40
              ...
              ${
                isPanelCollapsed
                  ? "-translate-x-full md:translate-x-0 w-0 md:w-0 overflow-hidden border-r-0"
                  : "translate-x-0 w-[85%] md:w-72 shadow-2xl md:shadow-none"
              }`}
          >
