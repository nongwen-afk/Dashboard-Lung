...
import { LayoutDashboard, MapPin, Bus, Users, BarChart3, Settings } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, transparent, rgba(37,99,235,0.30) 40%, rgba(71,85,105,0.25) 70%, transparent)",
        }}
      />
            ...
            style={
              isActive
                ? {
                    ...
                    boxShadow:
                      "0 2px 12px rgba(37,99,235,0.20), inset 0 1px 0 rgba(255,255,255,0.08)",
                    color: "#1e40af",
                  }
                : {
                    color: "#94a3b8",
            ...
            {isActive && (
              <div
                ...
                style={{
                  ...
                  boxShadow: "0 0 8px rgba(37,99,235,0.60)",
                }}
              />
            )}
      ...
      {/* Divider */}
      <div
        className="mt-auto mb-1 w-8 h-[0.0625rem]"
